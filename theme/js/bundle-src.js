...
// Generated by CoffeeScript 1.7.1
(function() {
  var $, $meta, DB, Prism, View, arg, baseURL, displayTag, helper, router, search, view;
  ...
  search = function(keyword) {
    return db.ready(function() {
      ...
      match = db.filter(function(post) {
        return JSON.stringify(post).toLowerCase().indexOf(keyword.toLowerCase()) > -1;
      });
      if (match.length > 0) {
  ...
  if ($meta.length > 0) {
    ...
    if (router === 'post') {
      $.get(baseURL + '/comments.html', function(data) {
...
},{"./db":2,"./helper":3,"./prism":5,"./view":6,"jquery":1}],5:[function(require,module,exports){
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+java+php+coffeescript+bash+c+cpp+python+http+ruby+csharp+go+scala+haskell+swift+objectivec */
